...
export function Div(classes, children, onCreate) {
    return initEl("div", classes, children, onCreate);
}
export function Span(classes, children, onCreate) {
    return initEl("span", classes, children, onCreate);
}
export function H1(classes, children, onCreate) {
    return initEl("h1", classes, children, onCreate);
}
export function Table(classes, children, onCreate) {
    return initEl("table", classes, children, onCreate);
}
export function TR(classes, children, onCreate) {
    return initEl("tr", classes, children, onCreate);
}
export function TD(classes, children, onCreate) {
...
export function Button(classes, children, clickListener, onCreate) {
    const button = initEl("button", classes, children, onCreate);
    if (clickListener)
        button.addEventListener("click", clickListener.bind(button, button));
    return button;
}
export function A(classes, children, href, clickListener, onCreate) {
